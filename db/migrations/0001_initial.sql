...
INSERT OR IGNORE INTO manufacturers (canonical_name, aliases, primary_category, source_url, notes) VALUES
    ...
    ('Rekor', NULL, 'alpr',
     'PROJECT_BIBLE.md#2.1', 'ALPR + face_recog (§2.1 #1, #10) — multi-category at vendor level.'),
    ('Avigilon', NULL, 'alpr',
    ...
    ('DJI', 'Da-Jiang Innovations', 'drone',
     'PROJECT_BIBLE.md#2.1', 'Matrice series in LE configurations (§2.1 #5).'),
    ('Skydio', NULL, 'drone',
     'PROJECT_BIBLE.md#2.1', 'X-series LE drones (§2.1 #5).'),
    ('BRINC', 'BRINC Drones', 'drone',
     'PROJECT_BIBLE.md#2.1', 'LEMUR drone (§2.1 #5).'),
    ('Parrot', NULL, 'drone',
     'PROJECT_BIBLE.md#2.1', 'ANAFI USA (§2.1 #5).'),
    ('SoundThinking', 'ShotSpotter', 'gunshot_detect',
     'PROJECT_BIBLE.md#2.1', 'Acoustic gunshot detection (§2.1 #6). Renamed from ShotSpotter.'),
    ('Hak5', NULL, 'hacking_tool',
     'PROJECT_BIBLE.md#2.1', 'WiFi Pineapple, Bash Bunny, Packet Squirrel (§2.1 #7).'),
    ('Cellebrite', NULL, 'hacking_tool',
     'PROJECT_BIBLE.md#2.1', 'UFED forensics (§2.1 #7).'),
    ('Magnet Forensics', 'Magnet, GrayKey (product)', 'hacking_tool',
     'PROJECT_BIBLE.md#2.1', 'GrayKey forensics tool (§2.1 #7).'),
    ('Berla', NULL, 'hacking_tool',
     'PROJECT_BIBLE.md#2.1', 'iVe vehicle forensics (§2.1 #7).'),
    ('BriefCam', NULL, 'face_recog',
     'PROJECT_BIBLE.md#2.1', 'Video analytics / face_recog (§2.1 #10).'),
    ('Clearview AI', 'Clearview', 'face_recog',
     'PROJECT_BIBLE.md#2.1', 'Face_recog endpoints where detectable (§2.1 #10).'),
    ('Dedrone', NULL, 'drone_detect',
     'PROJECT_BIBLE.md#2.1', 'Drone detection systems — also wireless emitters (§2.1 #11).'),
