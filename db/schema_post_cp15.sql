-- Argus schema dump — post-CP15 (migration 0015 applied)
-- Generated 2026-05-11 by CP15 Phase 4 application heartbeat
-- schema_version=15; 155 identifiers rows; 33 sources rows
-- Cumulative source_type enum (both tables): 10 values (CP15 added 'primary_registry')
...
-- Reproduce via: migrations 0001 → 0015 in order
...
-- v15: 0015_primary_registry_source_type_extension
