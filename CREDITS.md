...
| sid | Name | source_type | License | access_mode | admission_date_utc |
|---|---|---|---|---|---|
| 53 | Vendor Desktop Application Static Analysis — Wave H | vendor_documentation | per_vendor (no_license_declared_facts_only) | per_vendor_public_download_no_auth (cycle_completion_state=`partial_cohort_set_complete`) | 2026-05-18T00:00:00Z |
