...
| `procurement_records` | **50,492** | analytical-only (never exported to Lynceus per §11 #14); +2,560 net-new in v1.1.0 via the MAC-172 USAspending deep-extension; further admissions across v1.2.x to v1.6.x bring the live total to 50,492 |
...
| `reclassification_reason` | TEXT | yes | — | Per-row substantive rationale. Convention (NOT schema-enforced beyond NOT NULL): self-explanatory at row-level WITHOUT cross-referencing the dispatch: the MAC-88 a1dab600 §2 refinement. |
