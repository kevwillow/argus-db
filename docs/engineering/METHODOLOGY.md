...
The v1.5.0 lexicon-expansion wave (dispatch [MAC-232](<TRACKER_URL>issues/MAC-232); Two-Session Parallel Dispatch) anchored three new SAR codifications addressing cohort-disambiguation discipline:
